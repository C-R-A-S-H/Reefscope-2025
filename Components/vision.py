        ...
        for i in fiducial_results:
            ...
            self.target_relative_estimated_position = Pose3d(target_pose_robot_space[2],
                                                             ...
                                                             Rotation3d.fromDegrees(
                                                                 target_pose_robot_space[5],
                                                                 target_pose_robot_space[3],
                                                                 target_pose_robot_space[4])).toPose2d()
            self.robot_in_target_estimated_position = Pose3d(robot_pose_target_space[2],
                                                             ...
                                                             Rotation3d.fromDegrees(
                                                                 robot_pose_target_space[5],
                                                                 robot_pose_target_space[3],
                                                                 robot_pose_target_space[4])).toPose2d()
